...
public class FastStyleSlashEffectRender<T extends EntitySlashEffect> extends SlashEffectRenderer<T> {
    public FastStyleSlashEffectRender(EntityRendererProvider.Context context) {
        super(context);
    }

    private static final ResourceLocation modelLocation = Yakumoblade.prefix("model/util/specialrender/fast_style/slash.obj");
    private static final ResourceLocation textureLocation = Yakumoblade.prefix("model/util/specialrender/fast_style/slash.png");
